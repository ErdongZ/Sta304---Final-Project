...
raw_census_data <- read_dta("Sta304 - Final Project raw data.gz")
...
write_csv(reduced_census_data, "E:/Assignments/STA304/Sta304-Final Project/Sta304 - Final Project cleaned data.csv")
